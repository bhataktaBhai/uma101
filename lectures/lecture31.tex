...
\begin{thm}[Integral Triangle Inequality] \label{thm:integration:triangle}
...
\begin{thm}[The Second Fundamental Theorem of Calculus] \label{thm:integration:IIFTOC} ~\\
